	...
	<table class="table">
		...
		<c:forEach items="${products}" var="product">
			<tr>
				...
				<td><a href="<c:url value="/product/viewProduct/${product.id}"/>">infos</a>
				<a href="<c:url value="/admin/product/editProduct/${product.id}" />">edit</a>
				<a href="<c:url value="/admin/product/deleteProduct/${product.id}" />">delete</a>
				</td>
